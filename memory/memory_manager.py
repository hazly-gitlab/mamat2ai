...
def should_extract_memory(user_text: str, mamat_text: str, api_key: str = "") -> bool:
    try:
        from or_client import client

        combined = f"User: {user_text[:300]}\nMAMAT AI: {mamat_text[:1000]}"
...
def extract_memory(user_text: str, mamat_text: str, api_key: str = "") -> dict:
    try:
        from or_client import client

        combined = f"User: {user_text[:600]}\nMAMAT AI: {mamat_text[:300]}"
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building a MAMAT AI assistant')\n"
            ...
            f"- Extract from BOTH user and MAMAT AI turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"MAMAT AI assistant"}}}},\n'
